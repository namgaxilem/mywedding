...
export const INVITATIONS: Invitation[] = [
  ...
  // Nha gai
  { id: "nhuong-thao", name: "Nhường Thảo", pronoun: "Anh Chị", place: ["bride"], host: "family" },
  { id: "gia-dinh-binh-nguyen", name: "Cháu Bình Nguyên", pronoun: "Gia đình", place: ["bride"], host: "family" },
];
